...
//            // Decision making if vehicle is too close to the car in front
//            if (too_close){
//              ref_vel -= 0.23; // de-accelerate
//
//              // Speed to consider lane change 42 mph
//              if (ref_vel < 45){
//                // if vehicle is in left or right lane, change to mid lane
//                if (lane == 0 or lane == 2) {
//                  bool change_lane = true;
//                  for (int i = 0; i < mid_lane.size(); i++) {
//                    double diff = mid_lane[i] - car_s;
...
//                  }
//                }
//                  // If vehicle is in the middle lane, change to either left or right lane
//                else if (lane == 1){
//                  bool change_left = true;
//                  bool change_right = true;
//                  for (int i = 0; i < left_lane.size(); i++) {
//                    double diff = left_lane[i] - car_s;
//                    if ((diff > 15) or (diff < -5)) {
//                      change_left *= true;
//                    } else {
//                      change_left *= false;
//                    }
//                  }
//                  // Justify left lane change
//                  if (!change_left){
//                    for (int i = 0; i < right_lane.size(); i++) {
//                      double diff = right_lane[i] - car_s;
//                      if ((diff > 12) or (diff < -5)) {
//                        change_right *= true;
//                      } else {
//                        change_right *= false;
//                      }
...
//                    change_right = false;
//                  }
//                  // Justify right lane change
//                  if (change_right){
//                    lane = 2;
//                  }
//                }
//              }
//            }else if( ref_vel < 49.75){ // If under desired speed, accelerate
//              ref_vel += 0.27;
//            }
